...
public class ScritualFragmentActivity extends Fragment {
    ...
    private ObjectAnimator oa4 = new ObjectAnimator();
        ...
        private Intent f864i = new Intent();
        ...
        this._get_branch_all_request_listener = new RequestNetwork.RequestListener() {             @Override // com.fufufu.katrina.backup.RequestNetwork.RequestListener
            public void onResponse(String str, String str2, HashMap<String, Object> map) {
                if (!str2.contains("Sign in · GitLab")) {
                    ...
                    ScritualFragmentActivity.this.f865n = 0.0d;
                    for (int i = 0; i < ScritualFragmentActivity.this.ls_branch_all.size(); i++) {
                        ...
                        scritualFragmentActivity4.s_prop_branch_all = (String) scritualFragmentActivity4.ls_branch_all.get((int) ScritualFragmentActivity.this.f865n);
                        String[] strArrSplit = ScritualFragmentActivity.this.s_prop_branch_all.split("-", 6);
                        ...
                        ScritualFragmentActivity.this.f865n += 1.0d;
                    }
                    ...
                    listView.setAdapter((ListAdapter) scritualFragmentActivity5.new Lv_branch_allAdapter(scritualFragmentActivity5.lm_branch_all));
    ...
    private void initializeLogic() {
        ...
        new Handler().postDelayed(new Runnable() {             @Override // java.lang.Runnable
            public void run() {
                ...
                ScritualFragmentActivity.this.lm_release = (ArrayList) new Gson().fromJson(ScritualFragmentActivity.this.prefrelease.getString("release", ""), new TypeToken<ArrayList<HashMap<String, Object>>>() {                 }.getType());
    ...
    public void _onLoadBrand() {
        ...
        if (katrinaPROP == null || katrinaPROP.getStatus() == AsyncTask.Status.FINISHED) {
            ...
            SketchwareUtil.showMessage(getContext().getApplicationContext(), getString(C0978R.string.toast_proses_katrina_prop_pending));
        }
    }
    ...
    public class KatrinaPROP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            if (FileUtil.isExistFile(ScritualFragmentActivity.this.s_add_prop)) {
                ...
                if (scritualFragmentActivity2.jsonIsValid(scritualFragmentActivity2.s_custom_prop)) {
                    ScritualFragmentActivity.this.lm_json_brand = (ArrayList) new Gson().fromJson(ScritualFragmentActivity.this.s_custom_prop, new TypeToken<ArrayList<HashMap<String, Object>>>() {                     }.getType());
                }
            }
        }
        ...
        public void onPostExecute(Void r4) {
            ...
            ScritualFragmentActivity scritualFragmentActivity = ScritualFragmentActivity.this;
            recyclerView.setAdapter(scritualFragmentActivity.new Rv_1Adapter(scritualFragmentActivity.lm_json_brand));
    ...
    public class KatrinaREPLACEPROP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            ScritualFragmentActivity.this.s_printprop = new GsonBuilder().setPrettyPrinting().create().toJson((JsonElement) new Gson().fromJson(ScritualFragmentActivity.this.s_printprop, JsonObject.class));
            FileUtil.writeFile(ScritualFragmentActivity.this.s_systemprop, ScritualFragmentActivity.this.s_printprop);
            String[] strArrSplit = ScritualFragmentActivity.this.s_propvalue.split("\n");
            StringBuilder sb = new StringBuilder();
        ...
        public Void doInBackground(Void... voidArr) {
            while (!isCancelled()) {
                ...
                ScritualFragmentActivity.this.b_command = false;
                Shell.Result resultExec = Shell.cmd(ScritualFragmentActivity.this.s_command).exec();
                List<String> out = resultExec.getOut();
                resultExec.getCode();
                ScritualFragmentActivity.this.b_command = resultExec.isSuccess();
                ScritualFragmentActivity.this.s_commandResult = String.join("\n", out);
                if (!isCancelled()) {
                    return null;
                }
            }
    ...
    public void _goToResult() {
        _hideProgressDialog();
        this.f864i.setClass(getContext().getApplicationContext(), RitualResultActivity.class);
        this.f864i.putExtra("PROP", this.extraprop);
        this.f864i.putExtra("RESET0", this.extrareset);
        this.f864i.putExtra("WIPEGMS", this.extrawipe);
        this.f864i.putExtra("SSAID", this.extrassaid);
        this.f864i.putExtra("CLEANER", this.extracleaner);
        this.f864i.putExtra("REBOOT", this.extrareboot);
        this.f864i.putExtra("DALVIC", this.extradalvic);
        this.f864i.putExtra("NORESTART", this.extranorestart);
        this.f864i.putExtra("MODPES", this.extramodpes);
        startActivity(this.f864i);
    }
    ...
    public void _getPropResult() {
        ...
        for (int i = 0; i < this.ls_dump_prop.size(); i++) {
            if (this.ls_dump_prop.get((int) this.f865n).contains("manufacturer=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("MANUFACTURER", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("model=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("MODEL", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("version.release=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("RELEASE", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("hardware=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("HARDWARE", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("date=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("DATE", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("date.utc=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("UTC", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("fingerprint=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("FINGERPRINT", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("build.id=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("BUILDID", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("incremental=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("INCREMENTAL", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("bootloader=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("BOOT", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("description=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("DESCRIPTION", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("display.id=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("DISPLAY", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("flavor=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("FLAVOR", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("product=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("PRODUCT", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("host=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("HOST", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("user=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("USER", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("board=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("BOARD", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("brand=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("BRAND", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("device=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
                this.lm_dump_prop.get(0).put("DEVICE", this.s_prop_match);
            } else if (this.ls_dump_prop.get((int) this.f865n).contains("name=")) {
                this.s_prop_match = this.ls_dump_prop.get((int) this.f865n).replaceAll(".*=", "");
    ...
    private class DownloadTask extends AsyncTask<String, Integer, Boolean> {
        ...
        */
        public Boolean doInBackground(String... strArr) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        fileOutputStream = new FileOutputStream(ScritualFragmentActivity.this.s_filename);
                    } catch (Exception unused) {
        ...
        public void onProgressUpdate(Integer... numArr) {
            ...
            ScritualFragmentActivity.this.btn_download.setText(numArr[0] + "%");
        }
    ...
    public class KatrinaREADEXISTPROP extends AsyncTask<Void, Void, Void> {
        ...
        public Void doInBackground(Void... voidArr) {
            while (!isCancelled()) {
                ScritualFragmentActivity.this.b_command = false;
                Shell.Result resultExec = Shell.cmd(ScritualFragmentActivity.this.s_commandGetProp).exec();
                List<String> out = resultExec.getOut();
                resultExec.getCode();
                ScritualFragmentActivity.this.b_command = resultExec.isSuccess();
                ScritualFragmentActivity.this.s_getkatrinaprop = String.join("\n", out);
                if (!isCancelled()) {
                    return null;
                }
            }
        ...
        public void onPostExecute(Void r4) {
            ...
            ScritualFragmentActivity.this.m_systemprop = (HashMap) new Gson().fromJson(ScritualFragmentActivity.this.s_getkatrinaprop, new TypeToken<HashMap<String, Object>>() {             }.getType());
            ...
            ScritualFragmentActivity scritualFragmentActivity2 = ScritualFragmentActivity.this;
            recyclerView.setAdapter(scritualFragmentActivity2.new Rv_4Adapter(scritualFragmentActivity2.lm_editor));
    ...
    public class KatrinaCEKMODULE extends AsyncTask<Void, Void, Void> {
        ...
        public Void doInBackground(Void... voidArr) {
            while (!isCancelled()) {
                ...
                Shell.Result resultExec = Shell.cmd(ScritualFragmentActivity.this.s_commandModule).exec();
                List<String> out = resultExec.getOut();
                resultExec.getCode();
                ScritualFragmentActivity.this.b_commandModule = resultExec.isSuccess();
                ScritualFragmentActivity.this.s_resultModule = String.join("\n", out);
                if (!isCancelled()) {
                    return null;
                }
            }
        ...
        if (this.btn_install_module != null) {
            ...
            this.btn_install_module.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ModuleHelper.showInstallDialog(getContext(), "XKatrina", null);
                }
            });
        }
    }
    ...
    public class Rv_4Adapter extends RecyclerView.Adapter<Rv_4Adapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View viewInflate = ScritualFragmentActivity.this.getActivity().getLayoutInflater().inflate(C0978R.layout.new_ritual_editor_view, (ViewGroup) null);
    ...
    public class Rv_1Adapter extends RecyclerView.Adapter<Rv_1Adapter.ViewHolder> {
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View viewInflate = ScritualFragmentActivity.this.getActivity().getLayoutInflater().inflate(C0978R.layout.ritual_listview_brand_prop, (ViewGroup) null);
            viewInflate.setLayoutParams(new RecyclerView.LayoutParams(-1, -2));
            return new ViewHolder(viewInflate);
        }
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            materialCardView.setCardBackgroundColor(SurfaceColors.SURFACE_2.getColor(ScritualFragmentActivity.this.requireContext()));
    ...
    public class Rv_2Adapter extends RecyclerView.Adapter<Rv_2Adapter.ViewHolder> {
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View viewInflate = ScritualFragmentActivity.this.getActivity().getLayoutInflater().inflate(C0978R.layout.ritual_listview_detail_prop, (ViewGroup) null);
            viewInflate.setLayoutParams(new RecyclerView.LayoutParams(-1, -2));
            return new ViewHolder(viewInflate);
        }
    ...
    public class Rv_3Adapter extends RecyclerView.Adapter<Rv_3Adapter.ViewHolder> {
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View viewInflate = ScritualFragmentActivity.this.getActivity().getLayoutInflater().inflate(C0978R.layout.ritual_listview_editor_prop, (ViewGroup) null);
            viewInflate.setLayoutParams(new RecyclerView.LayoutParams(-1, -2));
            return new ViewHolder(viewInflate);
        }
