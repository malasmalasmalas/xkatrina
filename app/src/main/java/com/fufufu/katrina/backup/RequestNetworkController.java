...
public class RequestNetworkController {
    ...
    private OkHttpClient getClient() {
        if (this.client == null) {
            ...
            try {
                TrustManager[] trustManagerArr = {new X509TrustManager() {                     @Override // javax.net.ssl.X509TrustManager
                ...
                builder.hostnameVerifier(new HostnameVerifier() {                     @Override // javax.net.ssl.HostnameVerifier
    ...
    public void execute(final RequestNetwork requestNetwork, String str, String str2, final String str3, final RequestNetwork.RequestListener requestListener) {
        ...
        try {
            ...
            getClient().newCall(builder.build()).enqueue(new Callback() {                 @Override // okhttp3.Callback
                public void onFailure(Call call, final IOException iOException) {
                    ...
                    activity.runOnUiThread(new Runnable() {                         @Override // java.lang.Runnable
                        public void run() {
