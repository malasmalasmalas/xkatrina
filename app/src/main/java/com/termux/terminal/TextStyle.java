...
public final class TextStyle {
    ...
    static long encode(int i, int i2, int i3) {
        return ((i2 & ViewCompat.MEASURED_STATE_MASK) == -16777216 ? ((((long) i2) & 16777215) << 16) | 1024 : (((long) i2) & 511) << 16) | ((long) (i3 & FrameMetricsAggregator.EVERY_DURATION)) | ((i & ViewCompat.MEASURED_STATE_MASK) == -16777216 ? 512 | ((((long) i) & 16777215) << 40) : (((long) i) & 511) << 40);
    }
}
